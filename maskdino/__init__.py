...
from .data.dataset_mappers.coco_panoptic_new_baseline_dataset_mapper_higharc import COCOHigharcPanopticNewBaselineDatasetMapper
from .data.dataset_mappers.coco_panoptic_new_baseline_dataset_mapper_higharc_brochure import COCOHigharcBrochurePanopticNewBaselineDatasetMapper
