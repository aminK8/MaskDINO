...
HIGHARC_CATEGORIES = [
    ...
    {'color': [0, 220, 176], 'isthing': 0, 'id': 30, 'name': 'powder'},
    {'color': [255, 99, 164], 'isthing': 0, 'id': 31, 'name': 'reach_closet'},
    {'color': [92, 0, 73], 'isthing': 0, 'id': 32, 'name': 'reading_nook'},
    {'color': [133, 129, 255], 'isthing': 0, 'id': 33, 'name': 'rear_porch'}, 
    {'color': [78, 180, 255], 'isthing': 0, 'id': 34, 'name': 'solarium'}, 
    {'color': [0, 228, 0], 'isthing': 0, 'id': 35, 'name': 'stairs_editor'}, 
    {'color': [174, 255, 243], 'isthing': 0, 'id': 36, 'name': 'util_hall'},
    {'color': [45, 89, 255], 'isthing': 0, 'id': 37, 'name': 'walk'},
